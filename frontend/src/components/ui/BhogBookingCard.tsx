...
export const BhogBookingCard: React.FC<BhogBookingCardProps> = ({
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between p-4 border-1 rounded-xl transition-all duration-200 lg:hidden hover:border-primary/30">
      ...
      <div className="hidden lg:flex lg:items-center lg:justify-between lg:gap-4 lg:p-4.5 lg:border lg:border-primary/12 lg:rounded-lg">
        <div>
